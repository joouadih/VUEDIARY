    ...
    <div class="column is-half">
        ...
        <div class="field">
          <p class="control has-icons-left has-icons-right">
            <input id="email" class="input" type="text" placeholder="Email" v-model="user.email">
        ...
        <div class="field">
          <p class="control">
            <button class="button is-primary" @click.prevent="loginUser(user)">
              Login
            </button>
          </p>
        </div>
